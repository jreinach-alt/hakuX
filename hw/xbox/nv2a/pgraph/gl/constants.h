...
#  define NV2A_GL_TEXTURE_LOD_BIAS GL_TEXTURE_LOD_BIAS
# elif defined(GL_TEXTURE_LOD_BIAS_EXT)
#  define NV2A_GL_TEXTURE_LOD_BIAS GL_TEXTURE_LOD_BIAS_EXT
# else
#  define NV2A_GL_TEXTURE_LOD_BIAS 0
# endif
# ifdef GL_ANY_SAMPLES_PASSED
#  define NV2A_GL_ZPASS_QUERY_TARGET GL_ANY_SAMPLES_PASSED
# elif defined(GL_ANY_SAMPLES_PASSED_EXT)
#  define NV2A_GL_ZPASS_QUERY_TARGET GL_ANY_SAMPLES_PASSED_EXT
# else
#  define NV2A_GL_ZPASS_QUERY_TARGET 0
# endif
# ifdef GL_CLAMP_TO_BORDER
#  define NV2A_GL_CLAMP_TO_BORDER GL_CLAMP_TO_BORDER
# elif defined(GL_CLAMP_TO_BORDER_EXT)
#  define NV2A_GL_CLAMP_TO_BORDER GL_CLAMP_TO_BORDER_EXT
# elif defined(GL_CLAMP_TO_BORDER_OES)
#  define NV2A_GL_CLAMP_TO_BORDER GL_CLAMP_TO_BORDER_OES
# else
#  define NV2A_GL_CLAMP_TO_BORDER 0
# endif
# ifdef GL_TEXTURE_BORDER_COLOR
#  define NV2A_GL_TEXTURE_BORDER_COLOR GL_TEXTURE_BORDER_COLOR
# elif defined(GL_TEXTURE_BORDER_COLOR_EXT)
#  define NV2A_GL_TEXTURE_BORDER_COLOR GL_TEXTURE_BORDER_COLOR_EXT
# elif defined(GL_TEXTURE_BORDER_COLOR_OES)
#  define NV2A_GL_TEXTURE_BORDER_COLOR GL_TEXTURE_BORDER_COLOR_OES
# else
#  define NV2A_GL_TEXTURE_BORDER_COLOR 0
# endif
#else
...
#define NV2A_GL_TEXTURE_LOD_BIAS GL_TEXTURE_LOD_BIAS
#define NV2A_GL_ZPASS_QUERY_TARGET GL_SAMPLES_PASSED
#define NV2A_GL_CLAMP_TO_BORDER GL_CLAMP_TO_BORDER
#define NV2A_GL_TEXTURE_BORDER_COLOR GL_TEXTURE_BORDER_COLOR
#endif
...
static const SurfaceFormatInfo kelvin_surface_color_format_gl_map[] = {
    ...
    [NV097_SET_SURFACE_FORMAT_COLOR_LE_A8R8G8B8] =
        {4, GL_RGBA8, GL_BGRA, NV2A_GL_UNSIGNED_INT_8_8_8_8_REV, GL_COLOR_ATTACHMENT0},
    /* Seven-bit alpha under a fixed X bit; kept as RGBA8 like the Vulkan map,
     * so readback returns an 8-bit alpha where the guest expects X1A7. Was an
     * abort (issue #24). */
