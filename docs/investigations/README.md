...
| [`blend-fifth-quad.md`](blend-fifth-quad.md) | On the recovered 1,568-test oracle the blend arithmetic is exact on 4,480 of 4,480 quads, and the entire unsigned residual is one thing: the fifth quad renders the first quad's result, 1,119 times out of 1,120 |
