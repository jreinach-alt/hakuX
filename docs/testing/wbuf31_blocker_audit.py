...
def rivals(np, Image, root):
    ...
    print("units.  wbuf_anchor_recover.py instead compares the RECOVERED ANCHOR")
    print("against a rule's predicted anchor at a 0.01 px tolerance -- 30x wider")
    print("than the data supports -- and reports a miss as 'not an integer pixel")
    print("under any rule'.  That is a verdict on one rule at a time; scoring")
    print("against the interval, and fitting the family with a held-out residue,")
    print("is what turns TriV from unfitted into refuted.")
    print()
