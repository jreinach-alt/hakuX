    ...
    Case cases[] = {
        ...
        { "tri_fill_smooth_vk",
          { .primitive_mode = PRIM_TYPE_TRIANGLES,
            ...
            .smooth_shading = true },
          { .vulkan = true } },
        /* #223: the external-wedge path, emit_wedge(), in each arm it
         * generates differently -- flat colours, NOPERSPECTIVE weights with
         * cylinder wrap, and the GL / GLES spellings. */
        { "tri_fill_flat_vk",
          { .primitive_mode = PRIM_TYPE_TRIANGLES,
            .polygon_front_mode = POLY_MODE_FILL,
            .polygon_back_mode = POLY_MODE_FILL,
            .smooth_shading = false },
          { .vulkan = true } },
        { "tri_fill_smooth_zpersp_noperspective_cylwrap_vk",
          { .primitive_mode = PRIM_TYPE_TRIANGLES,
            .polygon_front_mode = POLY_MODE_FILL,
            .polygon_back_mode = POLY_MODE_FILL,
            .smooth_shading = true,
